 ...
 *
 * The schema types under `./generated/schema` are the legacy local webapp
 * contract. Hosted browser types are generated by `scripts/gen-hosted-contract`
 * into `./generated/hosted-schema`.
 */
