...
- **Simple clean architecture**: All Dirt application-service and browser-API consumers are repository-owned; direct contract cutovers must update or delete every caller without compatibility shims. Read [`docs/rules/simple-clean-architecture.md`](docs/rules/simple-clean-architecture.md) for the operational, data-safety, and outside-owned-contract exceptions.
