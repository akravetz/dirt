...
Ports `debug/automatic_model_training.py` (originally a Google Colab notebook)
...
cp debug/voice_samples/*.wav              $MINE/voice_samples/
cp debug/rirs/ir/*.wav                    $MINE/rirs/
...
is to run the three relevant cells of `debug/automatic_model_training.py` on
