...
| [Track A pollen run](breeding-track-a-2026-04-28/README.md) | `growrun.grow_run_id = breeding-track-a-2026-04-28` (`growrun.id = 2`) | `homebox` | `breeding` | Male sexing and pollen collection | R1-R5 |
