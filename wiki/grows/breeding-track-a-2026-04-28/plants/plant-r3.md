...
`SBBS-R1-007` remains a confirmed female culled from the Track A pollen run on 2026-06-04. No breeding photo is available today, and the active pollen-collection focus remains R2 under the repeated current-only wet Tent 2 sensor check. See [2026-06-25 daily](../../../daily/2026-06-25.md).
