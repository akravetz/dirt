...
seed batch. Seven regular seeds germinated, but two died during transplant to
coco coir, leaving five active plants: R1 through R5.

As of 2026-05-30, R1 and R4 have confirmed male pre-sex organs / male sex
...
- [R2](plants/plant-r2.md) — database `plant.id = 6`, `plant.plant_id = r2`
- [R3](plants/plant-r3.md) — database `plant.id = 7`, `plant.plant_id = r3`
