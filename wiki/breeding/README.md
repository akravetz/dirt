...
This section is the working manual for the small breeding program built around the Oregon Breeding Group seed packs. Background on Wayne / OBG / what BS01 is lives in [`concepts/oregon-breeding-group.md`](../concepts/oregon-breeding-group.md); the rationale for launching the program lives in [the launch decision](../decisions/2026-04-26-breeding-program-launch.md). The pages here are the *protocol* — how we actually do it.
...
2. **End at repeatable feminized seed production** — the mature system should produce large feminized batches where progeny tests show >90% on-target female offspring.
3. **Bank pollen from selected SBxBS01 males** — multi-year supply in dedicated freezer, ready for F2 creation and later progeny-tested family work.
4. **Pheno-hunt the SBxBS01 hybrid** — find keeper females that best express the target traits; color and trellis-friendly structure are now hard gates, with terps, finish-time, vigor, and resilience as tie-breakers/disqualifiers.
5. **Make F2 seed, then progeny-test F3/F4 families** — F2 is the variation-revealing generation, not the finish line.
...
- **Track A — pollen production.** Start all 10 SBxBS01 *regulars* now. Veg only long enough to make sturdy sex/pollen plants, then flip the batch to 12/12, cull females as soon as they declare, evaluate males (see [male-evaluation.md](male-evaluation.md)), collect separately labeled pollen, aliquot, and freeze. Total time germ → frozen pollen: ~7–8 weeks. Track A is the *speed track*. Current status: 10 regular seeds were started around 2026-04-28; 7 sprouted, all 7 were potted into coco/perlite on 2026-05-05, 5 looked healthy/vigorous as of 2026-05-05, and the seedlings have their first 2–3 sets of true leaves as of 2026-05-12. Short-veg target: give them roughly 7–14 more days, then flip once most have 4–5 nodes and steady new growth.
