...
Current grow                    ── flip ──────── flower (~9–10 wk) ──── harvest ──┐
                                                                                  ▼
...
- [x] **Start 10 SBxBS01 regulars** from the original-order pack. Started approximately 2026-04-28; 7 total sprouted, 2 died during transplant to coco coir, and 5 plants survived into Track A as R1-R5. The survivor pool was narrowed to R2 only on 2026-06-14 because R2 showed purple coloration on the pollen sacs; R1, R3, R4, and R5 are culled/not retained for pollen. See [Track A pollen run](../grows/breeding-track-a-2026-04-28/README.md), [2026-05-05](../daily/2026-05-05.md), [2026-06-04](../daily/2026-06-04.md), and [activity log](../log.md).
...
- [x] **2026-06-03:** R2 confirmed male pre-sex organs / male sex expression. Track A confirmed male set is now R1, R2, and R4; continue inspecting R3/R5 and evaluate confirmed males against [male-evaluation.md](male-evaluation.md) before pollen collection. See [Track A pollen run](../grows/breeding-track-a-2026-04-28/README.md).
- [x] **2026-06-04:** R3 confirmed female and culled. Track A active set is now R1/R2/R4 as confirmed male candidates plus R5 on sex watch. See [Track A pollen run](../grows/breeding-track-a-2026-04-28/README.md) and [2026-06-04](../daily/2026-06-04.md).
- [x] **2026-06-14:** Track A narrowed to R2 only. R2 was retained because it showed purple coloration on the pollen sacs; R1, R3, R4, and R5 are culled/not retained for pollen. See [Track A pollen run](../grows/breeding-track-a-2026-04-28/README.md) and [activity log](../log.md).
- [x] **After flip:** inspect nodes 4–6 with a loupe every 1–2 days. Cull females as soon as confirmed. Keep only male candidates that pass the [male-evaluation](male-evaluation.md) gates; Track A is now narrowed to R2 for purple pollen-sac expression.
...
- [x] **First 1–2 weeks after Track A flip (~2026-05-26 → 2026-06-09):** evaluate males per [male-evaluation.md](male-evaluation.md). Stem color, leaf morphology, vigor, terps via stem rub, structure. R2 is the selected donor after showing purple coloration on pollen sacs; losing plants were culled/not retained by 2026-06-14.
- [ ] **~2–4 weeks after Track A flip (~2026-06-02 → 2026-06-23, adjust to actual flip):** sacs swell and start to dehisce. Collect R2 pollen per [pollen-handling.md](pollen-handling.md). Label as R2-derived, dry with desiccant, flour-cut 4:1 if storing, aliquot into many small single-use tubes, freeze. Cull R2 after collection.
...
- [ ] **~2026-07-15 → 2026-08-05:** current grow harvests (assumes ~9–10 weeks of flower from mid-May flip).
- [ ] Pheno-rank A/B/C/D against the [scoring rubric](pheno-hunt-protocol.md). The clones from Phase 0 mean any current-grow plant is also a viable cross candidate.
