...
//
// Send-only; no response parsing. Posts as plant-{PLANT_ID}-node. The server
// derives placement from the Device row and computes the calibrated pct from raw via
